...
from platypus_qa.database.model import KnowledgeBase, FormatterError, QAInterpretation, QAInterpretationResult
...
QAInterpretation = QAInterpretation
QAInterpretationResult = QAInterpretationResult
